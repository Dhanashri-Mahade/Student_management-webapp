...
if (isset($_GET['delete_prn'])) {
    ...
    if ($deleteStudent->execute()) {
        ...
        // Error in deletion
        $message = "Error deleting student: " . $deleteStudent->error;
    }
...
<body>
    <div class="sidebar">
        ...
        <ul>
                ...
                <li>
                    <a href="a-students.php" class="active"><span><i class="las la-graduation-cap"></i></span>Students</a>
                </li>
                <li>
                ...
                <div class="card-header">
                    ...
                    <div class="card-body">
                            <table id="example" width="100%">
                                <?php
                                $addmissions = mysqli_query($conn, "SELECT * FROM `student` WHERE status = 'verified' ORDER BY 'name' ASC") or die('query failed');
                                ?>
                                <thead>
                                    <tr>
                                        <td>Photo</td>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            ...
                                            <td>
                                                    <a href='a-students.php?delete_prn=<?php echo $fetch['prn']; ?>' onclick="return confirm('Are you sure you want to delete this student?');">
