...
if (isset($_POST['update_profile'])) {
    ...
    mysqli_query($conn, "UPDATE `faculty` SET name = '$update_name', email = '$update_email', mobile = '$update_mobile' WHERE prn = '$user_id'") or die('query failed');
    ...
    if (!empty($new_pass) || !empty($confirm_pass)) {
        if ($new_pass != $confirm_pass) {
            ...
            mysqli_query($conn, "UPDATE `faculty` SET password = '$confirm_pass' WHERE prn = '$user_id'") or die('query failed');
    ...
    if (!empty($update_image)) {
        if ($update_image_size > 150000) {
            ...
            $select_img_query = mysqli_query($conn, "SELECT image FROM `faculty` WHERE prn = '$user_id'") or die('query failed');
            ...
            $image_update_query = mysqli_query($conn, "UPDATE `faculty` SET image = '$update_image' WHERE prn = '$user_id'") or die('query failed');
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="f-update.php"  class="active"><span><i class="las la-user-edit"></i></span>Update Profile</a>
                </li>
                <li>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="flex">
                    <div class="inputBox">
                        ...
                        <span>update your pic :(size<150kb)</span>
